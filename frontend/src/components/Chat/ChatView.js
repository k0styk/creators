...
class PersonalPage extends React.Component {
  render() {
    const { user, isDialogSelected, selectedDialog } = this.props;
    const dialogs = [
      {
      ...
      },
      {
        ...
        messages: [
          '02.08.21',
          {
            messageId: 1,
            message:
              'message2 message2 message2 message1 message1 message1 message1 message1 message1',
            messageFrom: 1,
            date: new Date('02.08.21 13:00'),
          },
          {
    ...
    const index = dialogs.findIndex(({ chatId }) => chatId === selectedDialog);
