  ...
  render() {
    ...
    return (
      <div className={s.videoBlock}>
        {youtubeId ? (
          <YouTube className={s.video} videoId={youtubeId} opts={this.opts} />
        ) : (
          <Stepper />
        )}
        <div>
          <BlockField
            ...
            value={<TextField size={'small'} onChange={setYoutubeId} />}
          />
          <BlockField
            isRequiered={true}
            title={'Название'}
          ...
          <BlockField
            ...
            value={
              <Select size={'small'} options={types} onChange={onChangeTypes} />
            }
          />
            ...
            value={
              <div>
                <TextField
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">д</InputAdornment>
                    ),
                  }}
                  defaultValue={0}
                  className={s.time}
